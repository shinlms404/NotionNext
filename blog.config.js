...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '1a5bfb19e5ea80dead21f132053c1599',
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '一个已经转化农业的咸鱼🐟💤', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.shinlms404.top', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客, shinlms404, Blog', // 网站关键词 英文逗号隔开
  ...
  GREETING_WORDS:
    ...
    'Hi，我是一个前程序员, Hi，现在是一个农业人,欢迎来到我的博客🎉',
